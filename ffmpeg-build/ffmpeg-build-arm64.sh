...
set -ex
./configure --extra-cflags="-fPIC -isysroot /Applications/Xcode_15_2_0.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk -mmacosx-version-min=11.0 -arch arm64" --extra-ldflags="-isysroot /Applications/Xcode_15_2_0.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk -mmacosx-version-min=11.0 -arch arm64"\
    --arch=arm64\
